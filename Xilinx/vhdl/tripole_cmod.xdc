...
set_property -dict {PACKAGE_PIN W3 IOSTANDARD LVCMOS33} [get_ports Run]
set_property -dict {PACKAGE_PIN V2 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports RunStatus]
